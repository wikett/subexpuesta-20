...
-->
  <footer class="mt-24 bg-blue-700">
    <div
      class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8"
    >
      <nav class="flex flex-wrap justify-center -mx-5 -my-2">
        <div class="px-5 py-2">
          <span class="text-base leading-6 text-gray-500 hover:text-gray-900">
            Contacto
          </span>
        </div>
        <div class="px-5 py-2">
      ...
      <p class="mt-8 text-base leading-6 text-center text-gray-400">
        &copy; 2020 Subexpuesta.com. Todos los derechos reservados.
      </p>
    </div>
  </footer>
  ...
  <!-- <div class="bg-blue-700">
    <div
      class="max-w-screen-xl px-4 pt-3 pb-12 mx-auto mt-48 sm:px-6 lg:pb-16 lg:px-8"
    >
      <div
